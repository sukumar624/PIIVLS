    ...
    return (
        <div className='page_container'>
            <div className="container">
                ...
                <p>
                    If eligible, students can apply for many prestigious scholarships, such as the Fullbright Scholarship (UK), the Chevening Scholarship (USA), the Australia Awards Scholarships (Australia), the
                    <Link>Gates Cambridge Scholarships</Link> (UK), the
                    <Link>Knight-Hennesy Scholars program</Link> at Stanford University (USA), the Eiffel Excellence Scholarships (France), and many others.<br />
                    &nbsp;
                </p>
